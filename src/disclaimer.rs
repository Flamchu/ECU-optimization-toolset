//! Project-wide disclaimer text.
//!
//! Single canonical string used by both the CLI banner and the report
//! header. Edit here and every consumer updates with it.

/// Verbatim safety / legal notice.
